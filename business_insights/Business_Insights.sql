...
-- PROJECT: E-Commerce SQL Data Analytics
-- SECTION: Business Insights & Recommendations
-- DATABASE: PostgreSQL (pgAdmin compatible)
-- ============================================================
-- Purpose: Each query below is annotated with the business
-- insight it reveals. These translate raw SQL results into
-- language suitable for stakeholder presentations.
-- ============================================================


-- ============================================================
-- INSIGHT 1: Revenue Concentration (Pareto / 80-20 Rule)
-- Finding: The top 20% of products typically account for ~80%
-- of revenue. Focus inventory and marketing on these products.
-- Action: Increase stock levels and ad spend on Pareto products.
-- ============================================================
...
-- Finding: Returning customers generate higher average order
-- values than one-time buyers — retention > acquisition.
-- Action: Invest in loyalty programmes and re-engagement
-- email flows for customers who haven't ordered in 60+ days.
-- ============================================================
...
-- Finding: Failed transactions represent direct revenue loss.
-- Certain payment methods may have disproportionate failure
-- rates, indicating integration or UX issues.
-- Action: Implement payment retry logic and surface alternative
-- methods at checkout when the primary method fails.
-- ============================================================
...
-- Finding: A small number of cities drive most of the revenue.
-- Action: Improve delivery SLAs and warehouse capacity in
...
-- Finding: Revenue peaks correlate with festivals, sales
-- events, or promotional campaigns.
-- Action: Plan inventory and staffing 6 weeks ahead of
-- historically high-revenue months.
-- ============================================================
...
-- Finding: Retention typically drops sharply after Month 1.
-- Improving Month-1 to Month-3 retention by 5% compounds
-- significantly over a full year.
-- Action: Launch a post-purchase onboarding sequence with
-- personalised product recommendations and a loyalty bonus.
-- ============================================================
...
-- Finding: Customers who registered but never ordered already
-- have brand awareness — they are the cheapest segment to
-- convert compared to cold acquisition.
-- Action: Send a personalised "we miss you" offer within
-- 30 days of signup with no purchase.
-- ============================================================
...
-- Finding: Identifying Champions, Loyal, At-Risk, and New
-- customers enables different marketing strategies per segment.
-- Action: Champions → exclusive loyalty perks.
--         At-Risk → win-back discount campaign.
